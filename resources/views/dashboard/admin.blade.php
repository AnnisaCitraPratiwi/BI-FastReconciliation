    ...
    <div class="col-md-3">
        <div class="card bg-secondary text-white mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h4>{{ $reconSessionsToday }}</h4>
                    <p class="mb-0">Reconciliation Sessions</p>
                </div>
    ...
    <div class="col-md-2">
        <div class="card bg-primary text-white mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h4>{{ $totalCipToday }}</h4>
                    <p class="mb-0">Total CIP Records</p>
                </div>
    ...
    <div class="col-md-2">
        <div class="card bg-success text-white mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h4>{{ $totalAmsToday }}</h4>
                    <p class="mb-0">Total AMS Records</p>
                </div>
                <i class="fas fa-database fa-2x opacity-75"></i>
            </div>
        </div>
    ...
    <div class="col-md-2">
        <div class="card bg-info text-white mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h4>{{ $totalBsToday }}</h4>
                    <p class="mb-0">Total BS Records</p>
                </div>
                <i class="fas fa-database fa-2x opacity-75"></i>
            </div>
        </div>
            ...
            <!-- Daily Anomalies Chart with Month Filter -->
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Daily Anomalies</h5>
                    <div class="d-flex align-items-center">
                ...
                <div class="card-body">
                    <canvas id="anomaliesChart" height="100"></canvas>
                </div>
            </div> 
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('reconciliation') }}" class="btn btn-primary btn-lg w-100 mb-3">
                                <i class="fas fa-calculator me-2"></i>
                                Start New Reconciliation
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('reconciliation.history') }}" class="btn btn-info btn-lg w-100 mb-3">
...
const dailyAnomalies = @json($dailyAnomalies);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(ctx, {
        type: 'line',
        data: {
            labels: dailyAnomalies.map(item => item.date),
            datasets: [{
                label: 'Anomalies',
                data: dailyAnomalies.map(item => item.anomalies),
