...
class AmsDataImport implements ToModel, WithHeadingRow, WithValidation, WithBatchInserts, WithChunkReading
{
    ...
    public function model(array $row)
    {
        ...
        return new AmsData([
            ...
            'trx_source' => $row['trxsource'] ?? $row['trx_source'] ?? null,
            'source_account_number' => $row['sourceaccountnumber'] ?? $row['source_account_number'] ?? '-',
            ...
            'trx_status' => $row['trxstatus'] ?? $row['trx_status'] ?? null,
